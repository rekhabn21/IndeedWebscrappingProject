...
public class newtest extends TestBaseJobScrapper {
	...
	public void apiJobSearch() throws IOException {
		...
		try {
			...
			// search.jobsdatatoexcel(Testutils.sheetname1, Testutils.apitesting);
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
	...
	public void restassuredJobSearch() throws IOException {
		...
		try {
			...
			//search.datacollectiontocsv(Testutils.sheetname2, Testutils.restassuredtesting);
	...
	public void postmanJobSearch() throws IOException {
		...
		try {
			...
			// search.datacollectiontocsv(Testutils.sheetname3, Testutils.postmantesting);
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
